...
export default function Card({id, description, year, country, sentence_year, play, isWinner, handleClick, start}) {
	let pointerEvents = !start ? " pointer-events-none" : ""
	return (
		<div 
			className={"flex flex-col justify-around items-center w-1/2 hover:bg-orange-100 hover:cursor-pointer sentence" + id + pointerEvents}
			onClick={handleClick}
		>
